...
const MailSenderForToken = (token, user) => {
        ...
        const verifyActivationLink = `http://127.0.0.1:3000/user/verify?token=${token}`;
        ...
        const activationLink = `<span style="color:black;font-size:10px;">or copy and paste this link on your browser</span><br /><a href="http://127.0.0.1:3000/user/verify?token=${token}" alt="activation link" style="font-size:10px;">http://127.0.0.1:3000/user/verify?token=${token}</a>`;
