                ...
                <form id="logInForm" className='max-w-[400px] w-full mx-auto mb-20 rounded-lg bg-skin-signup-signin-bg pt-2 pb-8 px-8 z-1' onSubmit={handleLogin}>
                    ...
                    <div className="flex flex-col text-gray-400 py-2">
                        <label htmlFor="email">E-mail address
                            <input className="rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none" type="text" name="email" onChange={handleChange} onKeyUp={handleKeyUp} />
                        </label>
                    </div>
                    {/* E-mail Address */}
