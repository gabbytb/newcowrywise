...
const AdminDashboardTwo = ({ isLoggedIn }) => {
    ...
    // ******************************************************************************
    // SET PAGE TITLE & ADD CUSTOM CLASS: "admin__dashboard" to the ADMIN DASHBOARD
    // ******************************************************************************
    useEffect(() => {
    ...
    //                                                     } else {
    //                                                         return (
    //                                                             <span className="bg-red-500 text-white">ALERT: <pre className="text-slate-700">No Role Assigned</pre></span>
    //                                                         );
    //                                                     };
    //                                                 })
    //                                             }
